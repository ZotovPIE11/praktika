...
export const PageHeader = () => {
  ...
  return (
    <div className="headerHeader">
      ...
      <div>
          <Link to="/menu" onClick={handleMenuToggle}>Методики</Link>
        </div>
        <div>
      ...
      <div className="header__icons">
        <div className={`header__burger-menu ${isMenuOpen ? 'visible' : ''}`}
          ...
          <div> 
            <img src="../../../images/burger2.png" alt="burger" className='burger'/>
          </div>
        </div>
      </div>
      <div className='name_header'>Сеть бассейнов “Дельфин”</div>
      <div class = "networks">
          <a href="https://yandex.ru/search/?clid=2721045-15&win=580&from=chromesearch&text=dr&lr=197"><img src="../../../images/вк2.png" alt="" class="img_nav" /></a>
